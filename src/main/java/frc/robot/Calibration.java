...
public class Calibration {
	...
	private final static double DT_A_ABS_ZERO_INITIAL = .344; // COMPEITION
	private final static double DT_B_ABS_ZERO_INITIAL = .553;
	private final static double DT_C_ABS_ZERO_INITIAL = .018;
	private final static double DT_D_ABS_ZERO_INITIAL = .954;

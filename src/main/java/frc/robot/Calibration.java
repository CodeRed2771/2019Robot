...
public class Calibration {
	...
	private final static double DT_A_ABS_ZERO_INITIAL = .277; // COMPEITION
	private final static double DT_B_ABS_ZERO_INITIAL = .554;
	private final static double DT_C_ABS_ZERO_INITIAL = .042;
	private final static double DT_D_ABS_ZERO_INITIAL = .924;

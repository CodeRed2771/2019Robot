...
public class Calibration {
	...
	private final static double DT_A_ABS_ZERO_INITIAL = .351; // COMPEITION
	private final static double DT_B_ABS_ZERO_INITIAL = .540;
	private final static double DT_C_ABS_ZERO_INITIAL = .034;
